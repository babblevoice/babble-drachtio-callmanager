...
module.exports.set = async ( c ) => {
  if( undefined === c.uuid || 0 === c.uuid.length ) return
...
*/
module.exports.getbyentity = async ( entity ) => {
  if( !storebyentity.has( entity ) ) return
  return storebyentity.get( entity )
}
