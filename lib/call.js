...
class call {
  ...
  */
  ...
  #configautoanswerfornewuac( options, u ) {
    ...
    if ( "autoanswer" in this.options.headers )
    {
      this.options.headers[ "Call-Info" ] = `<sip:${u.user}@${u.realm}>;answer-after=${this.options.headers[ "autoanswer" ]}`
      options.contactparams += ";intercom=true"
      delete this.options.headers.autoanswer
    }
