...
class call {
  ...
  */
  async update( options ) {
    ...
    if( !this.options.allow ) return false

    if( !/\bupdate\b/i.test( this.options.allow ) ) return false
  ...
  */
  ...
  The promise resolves to a new call if one is generated, or undefined if not.
  ...
  */
  async newuac( options, callbacks = {} ) {
    ...
    options.allow = this._req.get( "Allow" )
