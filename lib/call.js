...
class call {
  ...
  */
  ...
  /**
   * We are an outbound call.
   * @param { object } startingpoint 
   * @returns { object }
   */
  #outboundcallerid( startingpoint ) {
    if( this.parent ) {
      /* never assume both calls are in the same direction */
      if( "outbound" === this.parent.direction ) {
        startingpoint = this.parent.calledid
      } else {
  ...
  get callerid() {
    ...
    if( "outbound" === this.direction ) startingpoint = this.#outboundcallerid( startingpoint )
    else this.#inboundcallerid( startingpoint )
