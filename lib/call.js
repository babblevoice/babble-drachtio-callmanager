 ...
 */
  ...
  */
  ring() {
    ...
    if ( this.established && "uas" === this.type ) {
      this.channels.audio.play( this.mor )
    }
  ...
  */
  ...
  /**
   * Return the current mor
   */
  get mor() {
    if( this._mor ) {
      return this._mor
    }
    return callmanager.options.mor
  }
  ...
  */
  ...
  /**
   * Return the current moe
   */
  get moe() {
    if( this._moe ) {
      return this._moe
    }
    return callmanager.options.moe
  }
  ...
  */
  async hangup( reason ) {
    ...
    if( this.state.established ) {
      ...
      if( "TEMPORARILY_UNAVAILABLE" === reason ) {
        this.channels.audio.play( this.moe )
      }
      try {
