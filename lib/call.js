...
class call {
  ...
  */
  ...
  /**
   * Set ringtone if available
   * @param { object } options 
   */
  setringtone( options ) {
    if ( options.ringtone ) {
      options.headers[ options.ringtone.header ] = options.ringtone.url
      this.propagate.headers[ options.ringtone.header ] = options.ringtone.url
    }
    else if ( this.propagate.headers[ "sip_h_Alert-Info" ] ) { 
      // For polycom
      options.headers[ "sip_h_Alert-Info" ] = this.propagate.headers[ "sip_h_Alert-Info" ]
    }
    else if ( this.propagate.headers[ "alert_info" ] ) {
      // For Yealink
      options.headers[ "alert_info" ] = this.propagate.headers[ "alert_info" ]
    }
  }
