 ...
 */
  ...
  */
  ...
  #getsdpformodify( req ) {
    ...
    const codec = this.sdp.local.sdp.media[0].payloads.filter( value => media.payloads.includes( value ) )
    //const codec = this.sdp.local.intersection( media.payloads, true )
    this.sdp.local.sdp.media[0].payloads = codec.slice(0, 1)
